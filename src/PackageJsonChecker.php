...
class PackageJsonChecker
{
    ...
    private array $deprecatedConfigs = [
        ...
        '.eslintrc.cjs' => 'Migrate to eslint.config.mjs (flat config)',
        '.eslintrc.yaml' => 'Migrate to eslint.config.mjs (flat config)',
        '.eslintrc.yml' => 'Migrate to eslint.config.mjs (flat config)',
        '.eslintrc.json' => 'Migrate to eslint.config.mjs (flat config)',
        '.eslintignore' => 'Migrate to eslint.config.mjs (flat config)',
        'eslint.config.js' => 'Use eslint.config.mjs instead',
        'eslint.config.cjs' => 'Use eslint.config.mjs instead',
        '.eslintrc' => 'Migrate to eslint.config.mjs (flat config)',
        'playwright.config.js' => 'Use playwright.config.ts instead',
        'playwright.config.mjs' => 'Use playwright.config.ts instead',
        'playwright.config.cjs' => 'Use playwright.config.ts instead',
        'phpstan.neon' => 'Use phpstan.neon.dist instead',
        'phpunit.xml' => 'Use phpunit.xml.dist instead',
        'phpunit.dist.xml' => 'Use phpunit.xml.dist instead',
        '.prettierrc.yaml' => 'Convert to .prettierrc.json',
        '.prettierrc.yml' => 'Convert to .prettierrc.json',
        '.prettierrc' => 'Convert to .prettierrc.json',
        '.prettierrc.js' => 'Convert to .prettierrc.json',
        '.prettierrc.cjs' => 'Convert to .prettierrc.json',
        '.stylelintrc' => 'Convert to .stylelintrc.json',
        '.stylelintrc.js' => 'Convert to .stylelintrc.json',
        '.stylelintrc.yml' => 'Convert to .stylelintrc.json',
        '.stylelintrc.yaml' => 'Convert to .stylelintrc.json',
        '.markdownlint.yaml' => 'Use .markdownlint.json instead',
        '.markdownlint.yml' => 'Use .markdownlint.json instead',
        '.yamllint' => 'Use .yamllint.yml instead',
        '.yamllint.yaml' => 'Use .yamllint.yml instead',
